...
import examples.grpcclient.CoffeePotImpl;
...
public class Node {
  ...
  private void start() throws IOException {
    ...
    server = ServerBuilder.forPort(port)
        .addService(new examples.grpcclient.EchoImpl())
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    if (args[5].equals("true")) { // since I am too lazy to convert it to bool
      ...
      example.grpcclient.Register regThread = new example.grpcclient.Register(args[0], regPort, args[2], nodePort, args[4]);
      regThread.start();
    }
