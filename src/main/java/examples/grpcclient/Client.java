...
public class Client {
    ...
    private  ZooGrpc.ZooBlockingStub blockingStub5;
    private  CoffeePotGrpc.CoffeePotBlockingStub blockingStub6;

    private  GeometryCalculatorGrpc.GeometryCalculatorBlockingStub blockingStub7;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Boolean regOn = Boolean.valueOf(args[5]);
        try {
